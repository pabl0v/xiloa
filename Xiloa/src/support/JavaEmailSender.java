...
public class JavaEmailSender {
	...
	private void init(){
		try
		{
			USER_NAME = (String) this.jdbcTemplate.queryForObject("select mantenedor_valor from sccl.mantenedores where mantenedor_id = ?", new Object[]{new Long(53)}, String.class);
		}
		...
		try
		{		
			PASSWORD = (String) this.jdbcTemplate.queryForObject("select mantenedor_valor from sccl.mantenedores where mantenedor_id = ?", new Object[]{new Long(54)}, String.class);
		}
		catch(EmptyResultDataAccessException e)
		{
			PASSWORD = "sccl2013";
		...
		try
		{		
			HOST = (String) this.jdbcTemplate.queryForObject("select mantenedor_valor from sccl.mantenedores where mantenedor_id = ?", new Object[]{new Long(55)}, String.class);
		}
		catch(EmptyResultDataAccessException e)
		{
			HOST = "smtp.gmail.com";
		...
		try
		{		
			PORT = (String) this.jdbcTemplate.queryForObject("select mantenedor_valor from sccl.mantenedores where mantenedor_id = ?", new Object[]{new Long(56)}, String.class);
		}
		catch(EmptyResultDataAccessException e)
		{
			PORT = "587";
		...
		try
		{
			RESPONSIBLE = (String) this.jdbcTemplate.queryForObject("select mantenedor_valor from sccl.mantenedores where mantenedor_id = ?", new Object[]{new Long(57)}, String.class);
		}
		catch(EmptyResultDataAccessException e)
		{
